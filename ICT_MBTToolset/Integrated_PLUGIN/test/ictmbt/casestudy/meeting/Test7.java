...
public class Test7 {
	...
	public void test() throws Exception {
		...
		data=mtbToolSet.callToolSet("Meeting","[durationInMinutes>10 and durationInMinutes<=20]");
	...
	public void test2() throws Exception {
		MtbToolSet mtbToolSet=new MtbToolSet("C:/Users/Zainab/workspace3/ICT_MBTToolset/ICT_MBTToolset/Case studies/meeting/model.uml");
		data=mtbToolSet.callToolSet("Meeting","[durationInHours<=5 and noOfParticipants>=5]");
		assertNotEquals(null, data);
	//	fail("Not yet implemented");
	}
	@Test
