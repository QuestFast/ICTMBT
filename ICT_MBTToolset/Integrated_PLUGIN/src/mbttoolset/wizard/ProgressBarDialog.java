...
class SWTUtil {
	...
	static String path = "icons/process.gif";
	final static URL fullPathString = FileLocator.find(Platform.getBundle("plug"), new Path(path), null);
	static ImageDescriptor imageDesc = ImageDescriptor.createFromURL(fullPathString);
	static{
		imageRegistry.put(___IMAGE_Of_MESSAGE, imageDesc /*ImageDescriptor.createFromURL(newURL("icons/process.gif"))*/);
	}
